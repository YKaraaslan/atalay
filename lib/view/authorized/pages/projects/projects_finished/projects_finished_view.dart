...
class ProjectsFinishedView extends StatefulWidget {
  const ProjectsFinishedView({Key? key}) : super(key: key);

  @override
  State<ProjectsFinishedView> createState() => _ProjectsFinishedViewState();
}

class _ProjectsFinishedViewState extends State<ProjectsFinishedView> {
